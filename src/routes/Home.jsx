...
export default class Home extends Component{
    render(){
        ...
        return (
            <div style={{width:'100%',height:document.body.clientHeight-120,display:'flex',justifyContent:'center',alignItems:'center',fontSize:32,fontWeight:600}}>
                <div>Welcome to use this scaffold.<PandaIcon style={{ fontSize: 32 }} /></div>
            </div>
        )
    }
}
